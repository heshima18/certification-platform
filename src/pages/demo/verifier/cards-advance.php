            ...
            <div class="card-body">
                ...
                <form id="paymentDetailsForm" onsubmit="return false" class="pt-2">
                    ...
                    <div class="d-flex mb-4">
                        <div class="me-3">
                            <img src="../assets/img/icons/payments/visa-light.png" alt="Visa" height="30" data-app-light-img="icons/payments/visa-light.png" data-app-dark-img="icons/payments/visa-dark.png">
                        </div>
                    ...
                    <div class="d-flex mb-4">
                        <div class="me-3">
                            <img src="../assets/img/icons/payments/master-light.png" alt="MasterCard" height="30" data-app-light-img="icons/payments/master-light.png" data-app-dark-img="icons/payments/master-dark.png">
                        </div>
                        <div class="d-flex justify-content-between w-100 flex-wrap gap-2">
                            <div class="d-flex flex-column">
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <ul class="p-0 m-0">
                    ...
                    <li class="d-flex">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="../assets/svg/flags/cn.svg" alt="User" class="rounded-circle">
                        </div>
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <div class="d-flex align-items-center">
                ...
                <ul class="p-0 m-0">
                    <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                                <small class="fw-semibold">$1,619</small><i class='bx bx-chevron-up text-success ms-1'></i>
                    ...
                    <li class="d-flex mb-4 pb-1">
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                                <small class="fw-semibold">$3,571</small><i class='bx bx-chevron-up text-success ms-1'></i>
        ...
        <div class="card text-center h-100">
            <div class="card-header">
                <ul class="nav nav-pills nav- card-header-pills" role="tablist">
                    ...
                    <li class="nav-item">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-pills-os" aria-controls="navs-pills-os" aria-selected="false">Operating
                            System</button>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="p-0 m-0">
                    ...
                    <li class="d-flex mb-4">
                        <div class="d-flex w-100 flex-wrap justify-content-between gap-2">
                            ...
                            <div class="user-progress">
                                <i class='bx bx-down-arrow-alt text-danger me-2'></i> <small class="fw-semibold">- 8.5%
                                </small>
                            </div>
                        </div>
                    </li>
