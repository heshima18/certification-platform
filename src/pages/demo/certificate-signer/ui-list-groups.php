                        ...
                        <div class="col-md-8 col-12">
                            <div class="tab-content p-0">
                                <div class="tab-pane fade show active" id="list-home">
                                    ...
                                    marshmallow pudding
                                    bear claw cheesecake. Bonbon dragée cookie gummies. Pudding marzipan liquorice. Sugar plum
                                    dragée
                                    cupcake cupcake cake dessert chocolate bar. Pastry lollipop lemon drops lollipop halvah
                                    croissant.
                                ...
                                <div class="tab-pane fade" id="list-profile">
                                    ...
                                    Chocolate cake
                                    bonbon jelly beans lollipop jelly beans halvah marzipan danish pie. Oat cake chocolate
                                    cake pudding bear
                                    claw liquorice gingerbread icing sugar plum brownie. Toffee cookie apple pie cheesecake
                                    bear claw sugar
                                ...
                                <div class="tab-pane fade" id="list-messages">
                                    ...
                                    macaroon. Halvah
                                    jelly jelly beans cake macaroon jelly-o. Danish pastry dessert gingerbread powder halvah.
                                    Muffin bonbon
                                    fruitcake dragée sweet sesame snaps oat cake marshmallow cheesecake. Cupcake donut sweet
                                    bonbon
                                ...
                                <div class="tab-pane fade" id="list-settings">
                                    ...
                                    jelly-o. Jelly-o
                                    muffin macaroon cake gingerbread candy cupcake. Cake lollipop lollipop jelly brownie cake
                                    topping
                                    chocolate. Pie oat cake jelly. Lemon drops halvah jelly cookie bonbon cake cupcake ice
                                    cream. Donut tart
                                    bonbon sweet roll soufflé gummies biscuit. Wafer toffee topping jelly beans icing pie
                                    apple pie toffee
                ...
                <div class="demo-inline-spacing mt-3">
                    ...
                    <div class="tab-content px-0 mt-0">
                        ...
                        <div class="tab-pane fade" id="horizontal-settings">
                            ...
                            bonbon sweet roll
                            soufflé gummies biscuit. Wafer toffee topping jelly beans icing pie apple pie toffee pudding.
                            Tiramisu
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="demo-inline-spacing mt-3">
                    <div class="list-group">
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-success rounded p-1 me-3"><i class="bx bxl-vuejs bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-danger rounded p-1 me-3"><i class="bx bxl-angular bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-info rounded p-1 me-3"><i class="bx bxl-react bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
                        ...
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action d-flex align-items-center p-3">
                            <div class="badge bg-warning rounded p-1 me-3"><i class="bx bxl-redux bx-sm text-white"></i>
                            </div>
                            <div class="w-100">
