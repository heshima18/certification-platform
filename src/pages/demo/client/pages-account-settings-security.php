    ...
    <div class="col-md-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <p class="w-75">Two-factor authentication adds an additional layer of security
            ...
            <div class="row">
                ...
                <div class="col-md-7 order-md-1 order-0">
                    <div class="text-center mt-4 mx-3 mx-md-0">
                        <img src="../assets/img/illustrations/sitting-girl-with-laptop-light.png" class="img-fluid" alt="Api Key Image" width="350" data-app-light-img="illustrations/sitting-girl-with-laptop-light.png" data-app-dark-img="illustrations/sitting-girl-with-laptop-dark.png">
                    </div>
                </div>
            </div>
        </div>
