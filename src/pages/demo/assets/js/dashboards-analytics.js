...
!(function () {
    let o, r, e, t, s, i;
    i = (isDarkStyle
        ? ((o = config.colors_dark.cardColor), (r = config.colors_dark.headingColor), (e = config.colors_dark.bodyColor), (t = config.colors_dark.textMuted), config.colors_dark)
        : ((o = config.colors.cardColor), (r = config.colors.headingColor), (e = config.colors.bodyColor), (t = config.colors.textMuted), config.colors)
    ).borderColor;
    var a = document.querySelector("#orderChart"),
        ...
        n = {
            ...
            grid: { borderColor: i, padding: { top: 0, bottom: -8, left: 20, right: 20 } },
            xaxis: { categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], labels: { style: { fontSize: "13px", colors: t } }, axisTicks: { show: !1 }, axisBorder: { show: !1 } },
        ...
        n = {
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: { name: { offsetY: 15, color: e, fontSize: "15px", fontWeight: "600", fontFamily: "Public Sans" }, value: { offsetY: -25, color: r, fontSize: "22px", fontWeight: "500", fontFamily: "Public Sans" } },
                },
            },
        ...
        n = {
            ...
            legend: { show: !1 },
            xaxis: { categories: ["M", "T", "W", "T", "F", "S", "S"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { style: { colors: t, fontSize: "13px" } } },
            yaxis: { labels: { show: !1 } },
        },
        ...
        n = {
            ...
            colors: [config.colors.primary],
            fill: { type: "gradient", gradient: { shade: s, shadeIntensity: 0.6, opacityFrom: 0.5, opacityTo: 0.25, stops: [0, 95, 100] } },
            grid: { borderColor: i, strokeDashArray: 3, padding: { top: -20, bottom: -8, left: -10, right: 8 } },
            xaxis: { categories: ["", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul"], axisBorder: { show: !1 }, axisTicks: { show: !1 }, labels: { show: !0, style: { fontSize: "13px", colors: t } } },
